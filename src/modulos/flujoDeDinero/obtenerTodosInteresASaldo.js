...
async function ObtenerTodosInteresASaldo(req, res) {
    const { id } = req.params

    try {

        const result = await InteresASaldo.paginate({},{limit: 1000,sort: { createdAt: -1 }} )
        console.log(result)
...
module.exports = ObtenerTodosInteresASaldo